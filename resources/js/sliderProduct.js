export default function sliderProduct(){
    ...
    $(document).on('click','.btn-next',function(){
        ...
        let index = $(this).parents('.box-btn').next().find('.slider-product').find(`.${target}`).data('index');
        ...
        $(this).parents('.box-btn').next().find('.slider-product').find(`.${target}`).data('index',index);
