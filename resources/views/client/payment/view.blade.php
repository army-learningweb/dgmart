<x-client-layout>
    ...
    <div class="pt-3 animate_reveal px-5">
    ...
    <div class="flex flex-col md:flex-row items-start gap-3 mt-5 animate_reveal px-5">
        ...
        <div class="bg-white p-5 rounded-xl shadow-md w-full md:w-[45%]">
            <form action="{{ route('thanh-toan.create') }}" method="post">
                ...
                <div class="mt-2">
                    <x-input-field.field label="Họ và tên" type="text" name="name" id="name" required="*"
                ...
                <div class="mt-2">
                    <x-form-element.text-area label="Địa chỉ giao hàng" name="address" id="address" required="*"
                        class="h-[96px]" value="{{ Cookie::get('address') }}" />
                </div>
        ...
        <div class="w-full md:flex-1 bg-white p-5 rounded-xl shadow-md sticky top-4">
                ...
                <table class="md:w-full min-w-[500px]">
                    @foreach ($carts as $items)
                        <tr class="border-b border-gray-100">
                            <td class="px-2 py-2"><img src="{{ $items->options->image }}" alt=""
                                    class="w-20">
                            </td>
                            <td class="px-2 py-2">
                            ...
                            {{-- <td class="px-2 py-2">
                                <div
                                    class="flex gap-1 items-center text-blue-600 {{ $items->options->variants ? 'group' : '' }}">
            ...
            <div class="flex flex-col md:flex-row gap-y-2 md:gap-y-0 justify-between items-end mt-5 px-2">
