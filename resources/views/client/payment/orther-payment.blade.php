<x-client-layout>
    <div class="mx-auto flex flex-col md:flex-row gap-5 px-5 md:px-0">
        ...
        @if (session('order')['payment_method'] == 'momo')
            <div class="bg-gradient-to-r from-pink-500 to-pink-700 flex-1 rounded-2xl flex justify-center items-center order-1 md:order-2">
                <div class="flex flex-col justify-center items-center gap-5">
                    <div class="font-semibold text-2xl text-white tracking-tight my-5 md:my-0">Quét mã QR để thanh toán</div>
                    ...
                    <div class="text-white my-5 md:my-0 px-5 md:px-0 text-center">
