    ...
    <div class="flex gap-3 items-center mt-5">
        ...
        <ul class="flex gap-2 flex-wrap">
            ...
            @foreach ($categories as $item)
                <li class="px-4 py-[5px] rounded-full bg-blue-600/10 text-blue-600 cursor-pointer hover:outline-blue-600 hover:outline outline-1 post-category-item" data-category-id="{{ $item->id }}">{{ $item->name }}
                </li>
            @endforeach
        </ul>
    </div>
