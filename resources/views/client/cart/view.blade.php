<x-client-layout>
    ...
    <div class="pt-1 md:pt-3 px-4 md:px-0">
        <div class="flex justify-between items-end">
            ...
            @if ($top_sale)
                <div class="md:flex flex-col gap-2 items-end hidden">
                    <h1
                        class="font-[500] client-total-products text-2xl md:text-3xl flex gap-2 items-center tracking-tight">
    ...
    <div class="cart-wrapper">
        @include('client.cart.partials.list')
    </div>
