            ...
            @if ($top_sale && Cart::count() > 0)
                <div class="flex flex-col gap-2 items-end">
                    <h1 class="font-[500] client-total-products text-3xl flex gap-2 items-center tracking-tight">
                        ...
                        <span class="bg-gradient-to-r from-amber-500 to-red-600 bg-clip-text text-transparent py-1">Khám
                            phá
                            ngay
        ...
        <div class="mt-10 p-4 shadow-md rounded-2xl bg-white animate_reveal">
                ...
                @foreach ($carts as $items)
                    <tr class="border-b border-gray-100">
                        ...
                        <td class="px-5 text-center font-semibold price text-green-700"
                            data-row-id="{{ $items->rowId }}">{{ num_format($items->price * $items->qty) }}</td>
                        <td class="px-10">
            ...
            <div class="flex justify-between items-center gap-7 px-3">
                <div class="flex-1 flex flex-col gap-3 mt-3">
                    <h1
                        class="bg-gradient-to-r from-gray-600 to-gray-900 bg-clip-text text-transparent font-bold text-2xl py-1">
                        Ưu đãi giảm giá cho thành viên !
                    </h1>
                    <div>Bạn chưa là thành viên ? <a href=""
                            class="text-blue-600 hover:underline underline-offset-1">Đăng ký ngay</a></div>
                    <form action="" method="post" class="flex gap-2">
                        <input type="text" name="" id="" placeholder="Nhập mã giảm giá tại đây"
                            class="border-gray-300 rounded-md text-xs w-[200px] placeholder:italic">
                        <button
                            class="flex gap-2 items-center border border-blue-600 text-blue-600 hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-800 px-5 hover:text-white hover:border-none rounded-md py-[3px] text-[14px] hover:brightness-110 active:brightness-125">
    ...
    @else
        <div class="relative animate_reveal">
            ...
            <div class="absolute right-[10%] top-[30%] flex flex-col gap-2">
                ...
                <a href="/"
                    class="px-5 py-[7px] bg-gradient-to-r from-blue-600 to-blue-900 text-white rounded-md text-md w-fit hover:brightness-110 active:brightness-125">Mua
                    sắm ngay</a>
            </div>
        </div>
