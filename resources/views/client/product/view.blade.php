<x-client-layout>
    <div class="flex items-start gap-4 mt-4">
        ...
        <div class="bg-white shadow-md p-5 rounded-2xl flex-1 sticky top-4">
            <h1 class="font-semibold text-[16px]">Danh mục</h1>
            <hr class="my-3">
            <ul>
                @foreach ($products_categories as $item)
                    <li>
                        <a href="{{ $item->slug }}" class="hover:text-blue-600 py-[7px] flex justify-between">
                            <span>{{ $item->name }}</span>
                            <span>({{ $item->childs->count() }})</span>
                        </a>
                    </li>
                @endforeach
            </ul>
            ...
            <form action="" method="post">
                <div class="flex justify-between items-center py-2">
                    <div class="flex gap-5 items-center">
                        <h1 class="font-semibold text-lg">Tất cả sản phẩm ({{ $total }})</h1>
                        <div>
                            <div>
                                    ...
                                    <div class="flex justify-between my-3">
                                        <div class="flex gap-1 items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                fill="currentColor" class="size-6 text-amber-500">
                                        ...
                                        <div>
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                ...
                                                class="size-6 hover:text-pink-600">
                                                <path stroke-linecap="round" stroke-linejoin="round"
