    ...
    <ul class="grid grid-cols-4">
        <li class="pr-4">
            <div class="bg-white rounded-2xl shadow-md p-5">
                ...
                <div class="text-lg font-semibold mt-5">
                    <span class="text-blue-600">Hỗ trợ đổi trả,</span> với sản phẩm lỗi trong vòng 30 ngày
                </div>
            </div>
        </li>
        ...
        <li class="pr-4">
            <div class="bg-white rounded-2xl shadow-md p-5">
                ...
                <div class="text-lg font-semibold mt-5">
                    <span class="text-green-600">Thanh toán dễ dàng</span> mua trước trả sau, <span
                        class="text-green-600">lãi suất 0%</span>
                </div>
            </div>
        </li>
        ...
        <li class="pr-4">
            <div class="bg-white rounded-2xl shadow-md p-5">
                ...
                <div class="text-lg font-semibold mt-5">
                    <span class="text-amber-600">Miễn phí giao hàng,</span> siêu tốc liên tỉnh, nội thành
                </div>
            </div>
        </li>
        ...
        <li class="pr-4">
            <div class="bg-white rounded-2xl shadow-md p-5">
                ...
                <div class="text-lg font-semibold mt-5">
                    <span class="text-pink-600">Sự hài lòng</span> là động lực cho chúng tôi phát triển
                </div>
            </div>
        </li>
    </ul>
