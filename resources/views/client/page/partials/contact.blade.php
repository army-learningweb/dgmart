<div class="py-10">
    <div class="">
        <h1
            class="text-2xl font-bold bg-gradient-to-r from-blue-500 to-blue-800 bg-clip-text text-transparent tracking-tighter">
            Hỗ trợ & liên hệ
        </h1>
        <h1
        ...
        <p class="md:w-[70%] leading-6 mt-1">"Chúng tôi luôn luôn ở đây, để tiếp nhận phản hồi và hỗ trợ cho
            bạn, thắc mắc của bạn sẽ được giải đáp, Để lại thông tin bên dưới, bộ phận CSKH sẽ liên hệ với bạn trong
            24h tới"
        </p>
    </div>
    <div class="mt-10 flex items-start gap-4">
        <div class="w-[45%] bg-white shadow-md p-5 rounded-2xl">
        ...
        <div class="flex-1 bg-white shadow-md p-5 rounded-2xl">
            <h1 class="font-semibold text-lg">Thông tin về cửa hàng</h1>
            <div class="mt-3">
            ...
            <div class="mt-3 relative">
                <img src="{{ asset('images/map.png') }}" alt="" class="rounded-2xl w-full h-[300px] object-cover">
                <div class="absolute bottom-5 left-5 bg-white shadow-sm p-4 rounded-lg space-y-3">
                    ...
                    <div class="">
                        <a href="https://www.google.com/maps/search/Nguy%E1%BB%85n+Kho%C3%A1i+P2+Q4/@10.7538845,106.6932967,17z/data=!3m1!4b1?entry=ttu&g_ep=EgoyMDI2MDQxNC4wIKXMDSoASAFQAw%3D%3D" target="blank" class="flex gap-2 items-center border p-2 rounded-md w-fit hover:bg-blue-600 hover:text-white">
                            <span>Đường đi</span>
                            <span>
