...
<div
    class="modal-{{ $modal }} {{ $errors->any() && old('modal') == 'edit-user' ? '' : 'pointer-events-none opacity-0 scale-0' }}bg-[#1a1a1a]/30 backdrop-brightness-50 backdrop-blur-sm absolute left-0 top-0 z-50 w-full h-screen flex justify-center items-start">
        ...
        <div>
            ...
            <form action="{{ $route }}" method="post">
                ...
                <div class="mt-3 flex items-center justify-end gap-2">
                    ...
                    <x-primary-button class="py-[5px]">{{ $button_edit }}</x-primary-button>
                </div>
            </form>
        </div>
    </div>
