...
<ul class="flex py-4">
    <li class="flex-1">
        ...
        <div class="mt-2">
            Digimart tự hào là đơn vị hàng đầu cung cấp các giải pháp thiết bị số hiện đại. Cam kết mang đến những sản phẩm công nghệ chính hãng, chất lượng cao.
        </div>
    ...
    <li class="flex-1  px-10 py-4">
        ...
        <ul class="flex gap-2">
            <li><img src="{{ asset('images/applepay.png') }}" alt="" class="w-[80px] h-[55px] rounded-lg shadow-md"></li>
            <li><img src="{{ asset('images/vietcombank.webp') }}" alt="" class="w-[80px] h-[55px] rounded-lg shadow-md"></li>
            <li><img src="{{ asset('images/vietinbank.png') }}" alt="" class="w-[80px] h-[55px] rounded-lg shadow-md object-cover"></li>
            <li><img src="{{ asset('images/momo.svg') }}" alt="" class="w-[80px] h-[55px] rounded-lg shadow-md object-cover"></li>
        </ul>
    </li>
</ul>
