...
<div class="bg-white dark:bg-[#1e1f20] shadow-md mt-4 py-3 px-5 rounded-md text-sm overflow-x-auto md:overflow-visible">
    <table class="min-w-[1000px] md:w-full">
        ...
        <tr class="dark:text-gray-300 border-b border-gray-500/40 dark:hover:bg-[#292929] hover:bg-[#f5f5f5]">
            <td class="px-3 py-4">
                <input type="checkbox" name="user_id[]" value="" class="check_single rounded-[3px] mb-[2px]">
            </td>
            <td class="px-5">!</td>
            <td class="px-5">Tên</td>
            <td class="px-5">Slug</td>
            <td class="px-5">AAA</td>
            <td class="px-3">
                <x-select module="posts" class="select-status py-[3px] shadow-none text-[12px]"
                    data-id="">
                    <option value="active">Hoạt động</option>
                    <option value="unactive">Vô hiệu hóa</option>
                </x-select>
            </td>
            <td class="px-5">Ngày</td>
            <td class="px-3">Người tạo</td>
            <td>
                <div class="flex gap-4 justify-center">
                    <div class="open-modal edit-user open-modal-edit flex justify-center p-1 rounded-md text-[#5d82ee] hover:text-[#4049c8] cursor-pointer"
                        data-id="" data-modal="edit-user" data-module="users">
                    ...
                    <a href="" onclick="return confirm('Bạn có chắc muốn xóa danh mục này ra khỏi hệ thống ?')"
